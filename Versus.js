    ...
    setSkill = function (charObj, skill_id) {
        if (state['Versus'].sheet == '5e Shaped') {
            ...
            if (charAttr) {
                ...
                charObj.skill_ability = opt.ability;
